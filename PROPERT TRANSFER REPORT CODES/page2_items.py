...
def items_window():
            ...
            if itemloc == "Other":
                if len(specifyloc)==0:
                    ...
                    try:
                        ...
                        item_db = db.child("items_info").order_by_child("NO").get()
    ...
    #app logo
    app_logo = ctk.CTkImage(Image.open('resources\images\PTRLogo_White.png'), size=(25, 25))
    ...
    #add button
    add_button = ctk.CTkButton(frame2, command=add_item_firebase, text = 'Add', font= ctk.CTkFont('Arial', size = 18, weight = "bold"), text_color='black', corner_radius = 30)
