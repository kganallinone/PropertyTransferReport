...
def edit_item_window():
    ...
    edit_item.configure(fg_color = 'white')
    
    #header frame
    header_frame = ctk.CTkFrame(edit_item, fg_color='#313131', height=50, width=edit_item.winfo_width(), corner_radius=0)
    ...
    frame1 = ctk.CTkFrame(edit_item, fg_color='transparent')
    frame1.pack(fill = 'x')
    ...
    #for input
    frame2 = ctk.CTkFrame(edit_item, fg_color='transparent')
    ...
    #input
    frame3 = ctk.CTkFrame(edit_item, fg_color='transparent')
    frame3.pack(fill = 'x')
    ...
    #input
    frame4 = ctk.CTkFrame(edit_item, fg_color='transparent')
    frame4.pack(fill = 'x')
    ...
    frame5 = ctk.CTkFrame(edit_item, fg_color='transparent')
    frame5.pack(fill = 'x')
    ...
    frame6 = ctk.CTkFrame(edit_item, fg_color='transparent')
    frame6.pack(fill = 'x')
    ...
    #input
    frame7 = ctk.CTkFrame(edit_item, fg_color='transparent')
    frame7.pack(fill = 'x')
    
    description = ctk.CTkEntry(frame7, width=200, fg_color='white')
    description.pack(side = 'left', pady = 10, padx = 50)
    
    save = ctk.CTkButton(edit_item, text='Save', font=ctk.CTkFont('Arial', size = 18, weight='bold'), fg_color='#0077b8')
