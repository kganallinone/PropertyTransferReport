...
class request_user_window(ctk.CTkToplevel):
    def __init__(self, *args, **kwargs):
        ...
        app_pers2 = ctk.CTkLabel(egth_frame, text='Lynel P Tabien', font=ctk.CTkFont('Arial', size=14, weight="bold"), text_color='black')
        ...
        app_desg2 = ctk.CTkLabel(egth_frame, text='Laboratory Head and \nICT Coordinator', font=ctk.CTkFont('Arial', size=14, weight="bold"), text_color='black')
        ...
        #Date
        date = ctk.CTkLabel(egth_frame, text='06/08/2023', font=ctk.CTkFont('Arial', size=14, weight="bold"), text_color='black')
        ...
        app_pers2 = ctk.CTkLabel(nine_frame, text='Lynel P Tabien', font=ctk.CTkFont('Arial', size=14, weight="bold"), text_color='black')
        ...
        app_desg2 = ctk.CTkLabel(nine_frame, text='Laboratory Head and \nICT Coordinator', font=ctk.CTkFont('Arial', size=14, weight="bold"), text_color='black')
        ...
        #Date
        date = ctk.CTkLabel(nine_frame, text='06/08/2023', font=ctk.CTkFont('Arial', size=14, weight="bold"), text_color='black')
        date.pack(side = 'right', pady = 5, padx = 10, ipady =2, ipadx = 2)
        ...
        app_pers2 = ctk.CTkLabel(ten_frame, text='Lynel P Tabien', font=ctk.CTkFont('Arial', size=14, weight="bold"), text_color='black')
        ...
        app_desg2 = ctk.CTkLabel(ten_frame, text='Laboratory Head and \nICT Coordinator', font=ctk.CTkFont('Arial', size=14, weight="bold"), text_color='black')
        ...
        #Date
        date = ctk.CTkLabel(ten_frame, text='06/08/2023', font=ctk.CTkFont('Arial', size=14, weight="bold"), text_color='black')
        date.pack(side = 'right', pady = 5, padx = 10, ipady =2, ipadx = 2)
        date_label = ctk.CTkLabel(ten_frame, text='Date:', font=ctk.CTkFont('Arial', size=14, weight="normal"), text_color='black')
        date_label.pack(side = 'right', pady = 5)
        
        #Eleven Frame
        eleven_frame = ctk.CTkFrame(main_frame, fg_color='maroon', corner_radius=0,)
        ...
        print_button.pack(pady=5, padx=10)
