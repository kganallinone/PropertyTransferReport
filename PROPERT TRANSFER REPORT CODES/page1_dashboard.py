...
def dashboard_window():      
    ...
    from page2_items import items_window
    ...
    dashboard.iconbitmap('resources\images\PTR.ico')
    ...
    #app logo
    app_logo = ctk.CTkImage(Image.open('resources\images\DASHBOARD\PTRLogo_White.ico'), size=(25, 25))
    ...
    logout_button = ctk.CTkButton(header_frame,command=login_open,  text='Logout', font=ctk.CTkFont('Arial', size=15), fg_color='#AC0D0D', text_color='white', hover_color='#880808', width= 30)
    ...
    date_filter_icon = ctk.CTkImage(Image.open('resources\images\DASHBOARD\icons8-date-100.png'), size=(40, 40))
    ...
    items_button = ctk.CTkButton(nav_container, command=items_open, fg_color='transparent', image= items_icon, text='Items', width= 30, text_color='black', compound="top")
    ...
    history_icon = ctk.CTkImage(Image.open('resources\images\DASHBOARD\icons8-history-96.png'), size=(90, 90))
