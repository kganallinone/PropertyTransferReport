...
class dashboard_window(ctk.CTk):
    def __init__(self):
        ...
        content1_label = ctk.CTkLabel(content1, text="No. of Items", height=100, width=285, anchor="nw", font= ctk.CTkFont('Arial', size = 22, weight = "bold"))
        ...
        content2_label = ctk.CTkLabel(content2, text="No. of Transfers", height=100, width=285, anchor="nw", font= ctk.CTkFont('Arial', size = 22, weight = "bold"))
        ...
        content3_label = ctk.CTkLabel(content3, text="No. of Users", height=100, width=285, anchor="nw", font= ctk.CTkFont('Arial', size = 22, weight = "bold"))
        ...
        nav_container = ctk.CTkFrame(self, fg_color='transparent', width=self.winfo_width(), border_width=2, border_color='maroon')
        ...
        report_icon = ctk.CTkImage(Image.open('python property transfer\images\icons8-file-100.png'), size=(90, 90))
