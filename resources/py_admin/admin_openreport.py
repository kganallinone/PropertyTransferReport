...
def showptr_window(getptr):
    ...
    if db_remarks == 'REJECTED':
        ...
        c_edit = ctk.CTkButton(main, command='', text = 'EDIT', font= ctk.CTkFont('Arial', size = 15, weight = "bold"), fg_color='#187bcd', hover_color='#2a9df4', text_color='white', corner_radius = 30)
        c_edit.pack(side = 'right', pady = 5, padx = (0, 20))
